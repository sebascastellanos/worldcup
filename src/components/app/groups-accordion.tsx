...
const STAGE_LABELS: Record<string, string> = {
  ...
  LAST_32: '32avos', LAST_16: 'Octavos',
  ROUND_OF_32: '32avos', ROUND_OF_16: 'Octavos',
        ...
        <>
          ...
          <div ref={matchesRef} className="scroll-mt-4">
            {openStage && grouped[openStage] ? (
              <div className="bg-white/40 backdrop-blur-sm border border-white/60 rounded-2xl p-2 md:p-4 shadow-sm">
